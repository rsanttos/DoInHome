...
public class GestureEvents extends Application {
	...
	public void start(Stage stage) {
		...
		btnCol.setCellValueFactory(new Callback<CellDataFeatures<Person, Person>, ObservableValue<Person>>() {
			@Override
			public ObservableValue<Person> call(CellDataFeatures<Person, Person> features) {
						...
						if (person != null) {
							...
							button.setOnAction(new EventHandler<ActionEvent>() {
								...
								public void handle(ActionEvent event) {
									actionTaken.setText("Bought " + person.getLikes().toLowerCase() + " for: "
	...
	// icons for non-commercial use with attribution from:
	// http://www.iconarchive.com/show/veggies-icons-by-iconicon/bananas-icon.html
	// and http://www.iconarchive.com/show/collection-icons-by-archigraphs.html
